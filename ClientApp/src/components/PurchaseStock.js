...
const App = () => {
    const [PirchaseStockData, setPirchaseStockData] = useState([]);
    const columns = [
        {
            title: 'Сырье',
            dataIndex: 'feedstock',
    ...
    useEffect(()=>{
        fetch('https://localhost:7171/PurchaseStock/GetPurchaseStockData',{
            headers: {
